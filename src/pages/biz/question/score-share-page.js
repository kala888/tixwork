...
export default class ScoreSharePage extends Taro.PureComponent {
  render() {
    const { imageUrl, name = 'kala88', brief = 'wangzhe', score = 20, list = mockList } = this.props
      ...
      <View className='question-page'>
        <View className='score-detail'>
          ...
          <View className='score-detail-body'>
            <View className='score-detail-body-title'>挑战排行榜</View>
            {score && (
              <View className='score-detail-body-score'>
                <View className='score-detail-body-score-txt'>本次获得分数：{score}</View>
              </View>
            )}
