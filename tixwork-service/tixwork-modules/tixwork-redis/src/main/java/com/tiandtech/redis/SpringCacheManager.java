...
public class SpringCacheManager implements CacheManager {
    ...
    /**
     * Defines if cache aware of Spring-managed transactions. If {@code true} put/evict operations are executed only for successful
    ...
    /**
     * @param name 通过# 分割的多参数,name#ttl#maxIdleTime#maxSize
     */
    @Override
