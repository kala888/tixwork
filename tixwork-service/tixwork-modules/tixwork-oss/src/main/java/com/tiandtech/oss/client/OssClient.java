...
//            }
    ...
    public UploadResult uploadBySuffix(byte[] data, String suffix, String contentType) {
        String path = getPath(properties.getPrefix(), suffix);
        return upload(data, path, contentType);
    }

    public UploadResult uploadByName(byte[] data, String fileName, String contentType) {
        String path = getPath(properties.getPrefix(), "/" + fileName);
        return upload(data, path, contentType);
    }
